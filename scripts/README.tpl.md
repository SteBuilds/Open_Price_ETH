# Open Price ETH Data Repository (Public Version)

This is the public version. It is designed to be easily runnable by anyone — no special infrastructure or credentials required.
